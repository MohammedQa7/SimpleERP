            ...
            <div class="space-y-6">
                <form class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            <label for="departments" class="text-sm font-medium">Department</label>
                            <Select v-model="form.department">
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        <SelectItem v-for="(department, key) in departments" :key="key"
                                            :value="department" class="hover:bg-secondary cursor-pointer">
                                            {{ department }}
                                        </SelectItem>
                                    </SelectGroup>
                                </SelectContent>
