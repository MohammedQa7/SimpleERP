            ...
            <div v-else class="grid grid-cols-1 gap-4 py-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-sm font-medium">{{ invoice.order.customer.fullName }}</p>
                    </div>
                    <div>
                        <h3 class="text-sm font-medium text-muted-foreground mb-1">Invoice Date</h3>
                        <p class="text-sm font-medium">{{ invoice.order.createdAt }}</p>
                    </div>
                    <div>
                        <h3 class="text-sm font-medium text-muted-foreground mb-1">Ends in</h3>
                        <p class="text-sm font-medium">{{ invoice.endsAt ?? 'Already has been paid '}} </p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full border-collapse">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in invoice.order.orderItems" :key="index"
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="py-2 px-4 text-sm font-bold text-right">${{ invoice.order.totalPrice }}
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="py-2 px-4"></td>
                ...
                <div>
                    ...
                    <p class="text-sm">{{ invoice.order.notes }}</p>
                </div>
                ...
                <DialogFooter>
                    ...
                    <Button :disabled="invoice.isSent">
                        <span v-if="invoice.isSent">Already sent</span>
